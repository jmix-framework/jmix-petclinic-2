function i(a,t){for(var e=0;e<t.length;e++){const n=t[e];if(typeof n!="string"&&!Array.isArray(n)){for(const o in n)if(o!=="default"&&!(o in a)){const r=Object.getOwnPropertyDescriptor(n,o);r&&Object.defineProperty(a,o,r.get?r:{enumerable:!0,get:()=>n[o]})}}}return Object.freeze(Object.defineProperty(a,Symbol.toStringTag,{value:"Module"}))}var c={},l={get exports(){return c},set exports(a){c=a}};(function(a,t){ace.define("ace/theme/mono_industrial.css",["require","exports","module"],function(e,n,o){o.exports=`.ace-mono-industrial .ace_gutter {
  background: #1d2521;
  color: #C5C9C9
}
...
`}),ace.define("ace/theme/mono_industrial",["require","exports","module","ace/theme/mono_industrial.css","ace/lib/dom"],function(e,n,o){n.isDark=!0,n.cssClass="ace-mono-industrial",n.cssText=e("./mono_industrial.css");var r=e("../lib/dom");r.importCssString(n.cssText,n.cssClass,!1)}),function(){ace.require(["ace/theme/mono_industrial"],function(e){a&&(a.exports=e)})}()})(l);const s=c,u=i({__proto__:null,default:s},[c]);export{u as t};
