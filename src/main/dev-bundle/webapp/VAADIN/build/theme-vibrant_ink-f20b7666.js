function o(a,i){for(var e=0;e<i.length;e++){const n=i[e];if(typeof n!="string"&&!Array.isArray(n)){for(const c in n)if(c!=="default"&&!(c in a)){const r=Object.getOwnPropertyDescriptor(n,c);r&&Object.defineProperty(a,c,r.get?r:{enumerable:!0,get:()=>n[c]})}}}return Object.freeze(Object.defineProperty(a,Symbol.toStringTag,{value:"Module"}))}var t={},b={get exports(){return t},set exports(a){t=a}};(function(a,i){ace.define("ace/theme/vibrant_ink.css",["require","exports","module"],function(e,n,c){c.exports=`.ace-vibrant-ink .ace_gutter {
  background: #1a1a1a;
  color: #BEBEBE
}
...
`}),ace.define("ace/theme/vibrant_ink",["require","exports","module","ace/theme/vibrant_ink.css","ace/lib/dom"],function(e,n,c){n.isDark=!0,n.cssClass="ace-vibrant-ink",n.cssText=e("./vibrant_ink.css");var r=e("../lib/dom");r.importCssString(n.cssText,n.cssClass,!1)}),function(){ace.require(["ace/theme/vibrant_ink"],function(e){a&&(a.exports=e)})}()})(b);const k=t,l=o({__proto__:null,default:k},[t]);export{l as t};
