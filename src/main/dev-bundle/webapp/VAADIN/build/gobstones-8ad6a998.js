function L(n,t){for(var T=0;T<t.length;T++){const _=t[T];if(typeof _!="string"&&!Array.isArray(_)){for(const p in _)if(p!=="default"&&!(p in n)){const K=Object.getOwnPropertyDescriptor(_,p);K&&Object.defineProperty(n,p,K.get?K:{enumerable:!0,get:()=>_[p]})}}}return Object.freeze(Object.defineProperty(n,Symbol.toStringTag,{value:"Module"}))}var e={},o={get exports(){return e},set exports(n){e=n}};(function(n,t){ace.define("ace/snippets/gobstones.snippets",["require","exports","module"],function(T,_,p){p.exports=`# scope: gobstones
...
snippet docs (función con parámetros)
	/*
		...
		@TIPO: \${6:...}
	*/
`}),ace.define("ace/snippets/gobstones",["require","exports","module","ace/snippets/gobstones.snippets"],function(T,_,p){_.snippetText=T("./gobstones.snippets"),_.scope="gobstones"}),function(){ace.require(["ace/snippets/gobstones"],function(T){n&&(n.exports=T)})}()})(o);const F=e,C=L({__proto__:null,default:F},[e]);export{C as g};
