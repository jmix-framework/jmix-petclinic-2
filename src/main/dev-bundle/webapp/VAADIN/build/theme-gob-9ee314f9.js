function g(a,t){for(var n=0;n<t.length;n++){const e=t[n];if(typeof e!="string"&&!Array.isArray(e)){for(const c in e)if(c!=="default"&&!(c in a)){const o=Object.getOwnPropertyDescriptor(e,c);o&&Object.defineProperty(a,c,o.get?o:{enumerable:!0,get:()=>e[c]})}}}return Object.freeze(Object.defineProperty(a,Symbol.toStringTag,{value:"Module"}))}var r={},b={get exports(){return r},set exports(a){r=a}};(function(a,t){ace.define("ace/theme/gob.css",["require","exports","module"],function(n,e,c){c.exports=`.ace-gob .ace_gutter {
  background: #0B1818;
  color: #03EE03
}
...
`}),ace.define("ace/theme/gob",["require","exports","module","ace/theme/gob.css","ace/lib/dom"],function(n,e,c){e.isDark=!0,e.cssClass="ace-gob",e.cssText=n("./gob.css");var o=n("../lib/dom");o.importCssString(e.cssText,e.cssClass,!1)}),function(){ace.require(["ace/theme/gob"],function(n){a&&(a.exports=n)})}()})(b);const i=r,l=g({__proto__:null,default:i},[r]);export{l as t};
