function o(c,i){for(var a=0;a<i.length;a++){const e=i[a];if(typeof e!="string"&&!Array.isArray(e)){for(const n in e)if(n!=="default"&&!(n in c)){const A=Object.getOwnPropertyDescriptor(e,n);A&&Object.defineProperty(c,n,A.get?A:{enumerable:!0,get:()=>e[n]})}}}return Object.freeze(Object.defineProperty(c,Symbol.toStringTag,{value:"Module"}))}var t={},r={get exports(){return t},set exports(c){t=c}};(function(c,i){ace.define("ace/theme/iplastic.css",["require","exports","module"],function(a,e,n){n.exports=`.ace-iplastic .ace_gutter {
  background: #dddddd;
  color: #666666
}
...
`}),ace.define("ace/theme/iplastic",["require","exports","module","ace/theme/iplastic.css","ace/lib/dom"],function(a,e,n){e.isDark=!1,e.cssClass="ace-iplastic",e.cssText=a("./iplastic.css");var A=a("../lib/dom");A.importCssString(e.cssText,e.cssClass,!1)}),function(){ace.require(["ace/theme/iplastic"],function(a){c&&(c.exports=a)})}()})(r);const l=t,s=o({__proto__:null,default:l},[t]);export{s as t};
