function i(c,r){for(var n=0;n<r.length;n++){const e=r[n];if(typeof e!="string"&&!Array.isArray(e)){for(const a in e)if(a!=="default"&&!(a in c)){const o=Object.getOwnPropertyDescriptor(e,a);o&&Object.defineProperty(c,a,o.get?o:{enumerable:!0,get:()=>e[a]})}}}return Object.freeze(Object.defineProperty(c,Symbol.toStringTag,{value:"Module"}))}var t={},l={get exports(){return t},set exports(c){t=c}};(function(c,r){ace.define("ace/theme/cloud9_night.css",["require","exports","module"],function(n,e,a){a.exports=`.ace-cloud9-night .ace_gutter {
    background: #303130;
    color: #eee
}
...
`}),ace.define("ace/theme/cloud9_night",["require","exports","module","ace/theme/cloud9_night.css","ace/lib/dom"],function(n,e,a){e.isDark=!0,e.cssClass="ace-cloud9-night",e.cssText=n("./cloud9_night.css");var o=n("../lib/dom");o.importCssString(e.cssText,e.cssClass)}),function(){ace.require(["ace/theme/cloud9_night"],function(n){c&&(c.exports=n)})}()})(l);const g=t,d=i({__proto__:null,default:g},[t]);export{d as t};
