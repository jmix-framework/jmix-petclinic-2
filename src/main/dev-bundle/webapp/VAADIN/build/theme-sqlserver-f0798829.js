function l(n,o){for(var r=0;r<o.length;r++){const e=o[r];if(typeof e!="string"&&!Array.isArray(e)){for(const c in e)if(c!=="default"&&!(c in n)){const a=Object.getOwnPropertyDescriptor(e,c);a&&Object.defineProperty(n,c,a.get?a:{enumerable:!0,get:()=>e[c]})}}}return Object.freeze(Object.defineProperty(n,Symbol.toStringTag,{value:"Module"}))}var s={},t={get exports(){return s},set exports(n){s=n}};(function(n,o){ace.define("ace/theme/sqlserver.css",["require","exports","module"],function(r,e,c){c.exports=`.ace-sqlserver .ace_gutter {
    background: #ebebeb;
    color: #333;
    overflow: hidden;
}
...
`}),ace.define("ace/theme/sqlserver",["require","exports","module","ace/theme/sqlserver.css","ace/lib/dom"],function(r,e,c){e.isDark=!1,e.cssClass="ace-sqlserver",e.cssText=r("./sqlserver.css");var a=r("../lib/dom");a.importCssString(e.cssText,e.cssClass,!1)}),function(){ace.require(["ace/theme/sqlserver"],function(r){n&&(n.exports=r)})}()})(t);const A=s,i=l({__proto__:null,default:A},[s]);export{i as t};
