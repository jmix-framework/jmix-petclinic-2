function C(e,i){for(var n=0;n<i.length;n++){const a=i[n];if(typeof a!="string"&&!Array.isArray(a)){for(const c in a)if(c!=="default"&&!(c in e)){const o=Object.getOwnPropertyDescriptor(a,c);o&&Object.defineProperty(e,c,o.get?o:{enumerable:!0,get:()=>a[c]})}}}return Object.freeze(Object.defineProperty(e,Symbol.toStringTag,{value:"Module"}))}var r={},l={get exports(){return r},set exports(e){r=e}};(function(e,i){ace.define("ace/theme/ambiance.css",["require","exports","module"],function(n,a,c){c.exports=`.ace-ambiance .ace_gutter {
...
`}),ace.define("ace/theme/ambiance",["require","exports","module","ace/theme/ambiance.css","ace/lib/dom"],function(n,a,c){a.isDark=!0,a.cssClass="ace-ambiance",a.cssText=n("./ambiance.css");var o=n("../lib/dom");o.importCssString(a.cssText,a.cssClass,!1)}),function(){ace.require(["ace/theme/ambiance"],function(n){e&&(e.exports=n)})}()})(l);const t=r,m=C({__proto__:null,default:t},[r]);export{m as t};
