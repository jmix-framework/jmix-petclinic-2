function m(r,o){for(var n=0;n<o.length;n++){const e=o[n];if(typeof e!="string"&&!Array.isArray(e)){for(const a in e)if(a!=="default"&&!(a in r)){const c=Object.getOwnPropertyDescriptor(e,a);c&&Object.defineProperty(r,a,c.get?c:{enumerable:!0,get:()=>e[a]})}}}return Object.freeze(Object.defineProperty(r,Symbol.toStringTag,{value:"Module"}))}var t={},l={get exports(){return t},set exports(r){t=r}};(function(r,o){ace.define("ace/theme/kr_theme.css",["require","exports","module"],function(n,e,a){a.exports=`.ace-kr-theme .ace_gutter {
  background: #1c1917;
  color: #FCFFE0
}
...
`}),ace.define("ace/theme/kr_theme",["require","exports","module","ace/theme/kr_theme.css","ace/lib/dom"],function(n,e,a){e.isDark=!0,e.cssClass="ace-kr-theme",e.cssText=n("./kr_theme.css");var c=n("../lib/dom");c.importCssString(e.cssText,e.cssClass,!1)}),function(){ace.require(["ace/theme/kr_theme"],function(n){r&&(r.exports=n)})}()})(l);const s=t,k=m({__proto__:null,default:s},[t]);export{k as t};
