function l(a,t){for(var n=0;n<t.length;n++){const e=t[n];if(typeof e!="string"&&!Array.isArray(e)){for(const c in e)if(c!=="default"&&!(c in a)){const r=Object.getOwnPropertyDescriptor(e,c);r&&Object.defineProperty(a,c,r.get?r:{enumerable:!0,get:()=>e[c]})}}}return Object.freeze(Object.defineProperty(a,Symbol.toStringTag,{value:"Module"}))}var o={},i={get exports(){return o},set exports(a){o=a}};(function(a,t){ace.define("ace/theme/katzenmilch.css",["require","exports","module"],function(n,e,c){c.exports=`.ace-katzenmilch .ace_gutter,
...
`}),ace.define("ace/theme/katzenmilch",["require","exports","module","ace/theme/katzenmilch.css","ace/lib/dom"],function(n,e,c){e.isDark=!1,e.cssClass="ace-katzenmilch",e.cssText=n("./katzenmilch.css");var r=n("../lib/dom");r.importCssString(e.cssText,e.cssClass,!1)}),function(){ace.require(["ace/theme/katzenmilch"],function(n){a&&(a.exports=n)})}()})(i);const g=o,A=l({__proto__:null,default:g},[o]);export{A as t};
