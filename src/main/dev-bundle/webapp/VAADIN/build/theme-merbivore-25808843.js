function i(n,t){for(var r=0;r<t.length;r++){const e=t[r];if(typeof e!="string"&&!Array.isArray(e)){for(const a in e)if(a!=="default"&&!(a in n)){const c=Object.getOwnPropertyDescriptor(e,a);c&&Object.defineProperty(n,a,c.get?c:{enumerable:!0,get:()=>e[a]})}}}return Object.freeze(Object.defineProperty(n,Symbol.toStringTag,{value:"Module"}))}var o={},m={get exports(){return o},set exports(n){o=n}};(function(n,t){ace.define("ace/theme/merbivore.css",["require","exports","module"],function(r,e,a){a.exports=`.ace-merbivore .ace_gutter {
  background: #202020;
  color: #E6E1DC
}
...
`}),ace.define("ace/theme/merbivore",["require","exports","module","ace/theme/merbivore.css","ace/lib/dom"],function(r,e,a){e.isDark=!0,e.cssClass="ace-merbivore",e.cssText=r("./merbivore.css");var c=r("../lib/dom");c.importCssString(e.cssText,e.cssClass,!1)}),function(){ace.require(["ace/theme/merbivore"],function(r){n&&(n.exports=r)})}()})(m);const b=o,s=i({__proto__:null,default:b},[o]);export{s as t};
