function o(n,m){for(var a=0;a<m.length;a++){const e=m[a];if(typeof e!="string"&&!Array.isArray(e)){for(const t in e)if(t!=="default"&&!(t in n)){const c=Object.getOwnPropertyDescriptor(e,t);c&&Object.defineProperty(n,t,c.get?c:{enumerable:!0,get:()=>e[t]})}}}return Object.freeze(Object.defineProperty(n,Symbol.toStringTag,{value:"Module"}))}var r={},l={get exports(){return r},set exports(n){r=n}};(function(n,m){ace.define("ace/theme/terminal.css",["require","exports","module"],function(a,e,t){t.exports=`.ace-terminal-theme .ace_gutter {
  background: #1a0005;
  color: steelblue
}
...
`}),ace.define("ace/theme/terminal",["require","exports","module","ace/theme/terminal.css","ace/lib/dom"],function(a,e,t){e.isDark=!0,e.cssClass="ace-terminal-theme",e.cssText=a("./terminal.css");var c=a("../lib/dom");c.importCssString(e.cssText,e.cssClass,!1)}),function(){ace.require(["ace/theme/terminal"],function(a){n&&(n.exports=a)})}()})(l);const i=r,_=o({__proto__:null,default:i},[r]);export{_ as t};
