function p(e,s){for(var n=0;n<s.length;n++){const t=s[n];if(typeof t!="string"&&!Array.isArray(t)){for(const l in t)if(l!=="default"&&!(l in e)){const r=Object.getOwnPropertyDescriptor(t,l);r&&Object.defineProperty(e,l,r.get?r:{enumerable:!0,get:()=>t[l]})}}}return Object.freeze(Object.defineProperty(e,Symbol.toStringTag,{value:"Module"}))}var i={},a={get exports(){return i},set exports(e){i=e}};(function(e,s){ace.define("ace/snippets/lsl.snippets",["require","exports","module"],function(n,t,l){l.exports=`snippet @
	@\${1:label};
...
`}),ace.define("ace/snippets/lsl",["require","exports","module","ace/snippets/lsl.snippets"],function(n,t,l){t.snippetText=n("./lsl.snippets"),t.scope="lsl"}),function(){ace.require(["ace/snippets/lsl"],function(n){e&&(e.exports=n)})}()})(a);const o=i,$=p({__proto__:null,default:o},[i]);export{$ as l};
