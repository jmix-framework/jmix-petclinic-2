function i(n,c){for(var o=0;o<c.length;o++){const e=c[o];if(typeof e!="string"&&!Array.isArray(e)){for(const r in e)if(r!=="default"&&!(r in n)){const t=Object.getOwnPropertyDescriptor(e,r);t&&Object.defineProperty(n,r,t.get?t:{enumerable:!0,get:()=>e[r]})}}}return Object.freeze(Object.defineProperty(n,Symbol.toStringTag,{value:"Module"}))}var a={},l={get exports(){return a},set exports(n){a=n}};(function(n,c){ace.define("ace/theme/tomorrow_night_blue.css",["require","exports","module"],function(o,e,r){r.exports=`.ace-tomorrow-night-blue .ace_gutter {
  background: #00204b;
  color: #7388b5
}
...
`}),ace.define("ace/theme/tomorrow_night_blue",["require","exports","module","ace/theme/tomorrow_night_blue.css","ace/lib/dom"],function(o,e,r){e.isDark=!0,e.cssClass="ace-tomorrow-night-blue",e.cssText=o("./tomorrow_night_blue.css");var t=o("../lib/dom");t.importCssString(e.cssText,e.cssClass,!1)}),function(){ace.require(["ace/theme/tomorrow_night_blue"],function(o){n&&(n.exports=o)})}()})(l);const u=a,g=i({__proto__:null,default:u},[a]);export{g as t};
