function t(a,d){for(var n=0;n<d.length;n++){const e=d[n];if(typeof e!="string"&&!Array.isArray(e)){for(const r in e)if(r!=="default"&&!(r in a)){const c=Object.getOwnPropertyDescriptor(e,r);c&&Object.defineProperty(a,r,c.get?c:{enumerable:!0,get:()=>e[r]})}}}return Object.freeze(Object.defineProperty(a,Symbol.toStringTag,{value:"Module"}))}var o={},_={get exports(){return o},set exports(a){o=a}};(function(a,d){ace.define("ace/theme/nord_dark.css",["require","exports","module"],function(n,e,r){r.exports=`.ace-nord-dark .ace_gutter {
  color: #616e88;
}
...
`}),ace.define("ace/theme/nord_dark",["require","exports","module","ace/theme/nord_dark.css","ace/lib/dom"],function(n,e,r){e.isDark=!0,e.cssClass="ace-nord-dark",e.cssText=n("./nord_dark.css"),e.$selectionColorConflict=!0;var c=n("../lib/dom");c.importCssString(e.cssText,e.cssClass,!1)}),function(){ace.require(["ace/theme/nord_dark"],function(n){a&&(a.exports=n)})}()})(_);const s=o,i=t({__proto__:null,default:s},[o]);export{i as t};
