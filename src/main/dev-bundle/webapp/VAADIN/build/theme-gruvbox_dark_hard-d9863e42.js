function t(e,d){for(var r=0;r<d.length;r++){const a=d[r];if(typeof a!="string"&&!Array.isArray(a)){for(const n in a)if(n!=="default"&&!(n in e)){const c=Object.getOwnPropertyDescriptor(a,n);c&&Object.defineProperty(e,n,c.get?c:{enumerable:!0,get:()=>a[n]})}}}return Object.freeze(Object.defineProperty(e,Symbol.toStringTag,{value:"Module"}))}var o={},b={get exports(){return o},set exports(e){o=e}};(function(e,d){ace.define("ace/theme/gruvbox_dark_hard.css",["require","exports","module"],function(r,a,n){n.exports=`.ace-gruvbox-dark-hard .ace_gutter {
  background: #1d2021;
...
`}),ace.define("ace/theme/gruvbox_dark_hard",["require","exports","module","ace/theme/gruvbox_dark_hard.css","ace/lib/dom"],function(r,a,n){a.isDark=!0,a.cssClass="ace-gruvbox-dark-hard",a.cssText=r("./gruvbox_dark_hard.css");var c=r("../lib/dom");c.importCssString(a.cssText,a.cssClass)}),function(){ace.require(["ace/theme/gruvbox_dark_hard"],function(r){e&&(e.exports=r)})}()})(b);const u=o,_=t({__proto__:null,default:u},[o]);export{_ as t};
