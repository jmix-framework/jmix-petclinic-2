function l(a,d){for(var c=0;c<d.length;c++){const e=d[c];if(typeof e!="string"&&!Array.isArray(e)){for(const n in e)if(n!=="default"&&!(n in a)){const o=Object.getOwnPropertyDescriptor(e,n);o&&Object.defineProperty(a,n,o.get?o:{enumerable:!0,get:()=>e[n]})}}}return Object.freeze(Object.defineProperty(a,Symbol.toStringTag,{value:"Module"}))}var r={},t={get exports(){return r},set exports(a){r=a}};(function(a,d){ace.define("ace/theme/cloud9_day.css",["require","exports","module"],function(c,e,n){n.exports=`.ace-cloud9-day .ace_gutter {
    background: #ECECEC;
    color: #333;
}
...
`}),ace.define("ace/theme/cloud9_day",["require","exports","module","ace/theme/cloud9_day.css","ace/lib/dom"],function(c,e,n){e.isDark=!1,e.cssClass="ace-cloud9-day",e.cssText=c("./cloud9_day.css");var o=c("../lib/dom");o.importCssString(e.cssText,e.cssClass)}),function(){ace.require(["ace/theme/cloud9_day"],function(c){a&&(a.exports=c)})}()})(t);const u=r,A=l({__proto__:null,default:u},[r]);export{A as t};
